<template>
  <div class="home-making article">
    <section class="link flex gap-2">
      <a href="https://tools.bearune.com/" target="_blank" class="link__main"
    ...
    <section class="background">
      <p>
        一個嘗試使用不同前端庫的合集網站：以
        <a href="https://github.com/fengyuanchen/compressorjs" target="_blank"
          ><code>Compressor.js</code></a
        >
        實現前端圖片壓縮；以
        <a href="https://github.com/soldair/node-qrcode" target="_blank"
          ><code>node-qrcode</code></a
        >
        生成 QR Code；以 <code>EmojiAPI</code> 整理所有 Emoji，並分門別類。其中還使用
        <a href="https://github.com/Stuk/jszip" target="_blank"><code>JSZip</code></a> 及
        <a href="https://github.com/eligrey/filesaver.js/" target="_blank"
          ><code>FileSaver.js</code></a
        >
        實現壓縮與打包下載的功能，是一次有趣的嘗試。
      </p>
    </section>
    <section>
