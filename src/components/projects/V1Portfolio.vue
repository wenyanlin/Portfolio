<template>
  <div class="home-making article">
    <section class="link flex gap-2">
      <a href="https://wenyanlin.github.io/" target="_blank" class="link__main"><span class="mb-0.25">造訪網站</span>
        <Website />
      </a>
      <a href="https://github.com/wenyanlin/wenyanlin.github.io" target="_blank"><span class="mt-0.25"><GitHub/></span>
      </a>
    </section>
    <section class="background">
      <p>
        我的個人舊版作品集，是學習 Vue 初期時的練習，使用 Nuxt 3 + Tailwind CSS，並詳細記錄了每一個作品的可公開內容。目前該舊版作品集仍提供本網站《Wen Yan》部分作品的詳細內容連結。
      </p>
    </section>
    <section>
...
const toolSet = [
  ...
  {
    title: '開發語言',
    list: ['HTML', 'SCSS', 'JavaScript', 'Vue 3', 'Tailwind CSS'],
  }
]
</script>
