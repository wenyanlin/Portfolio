<template>
  <div class="flex justify-center items-center">
    <div
      class="relative max-w-[var(--space-xl)] flex flex-col justify-between mx-4 md:mx-16 lg:mx-8 2xl:mx-0"
    >
      <div class="shape fixed top-0 left-0 w-full h-screen scale-100 -z-40"></div>
