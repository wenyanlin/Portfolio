<template>
  ...
  <main class="pt-24 col-span-1 lg:col-span-3">
    <section class="about mb-32" id="about">
      <div
        class="about__inner text-lg text-neutral tracking-wider leading-loose break-words space-y-4"
        data-aos="fade-up"
      >
        <p>
        ...
        <p>
          ...
          Gemini 2.0 Flash 的 API 接入 LINE
    ...
    >
      <div>
        ...
        >
          ...
          <a href="/林文姸的履歷.pdf" target="_blank" data-aos="fade-up"
...
const experienceData = [
  ...
  },
  {
    ...
    company: '巨匠電腦股份有限公司',
    responsibilities:
      '協同高齡者適應與學習新科技，輔助教師指導40至75歲以上學員電腦及手機應用，並成功指導了 200+ 學員掌握：智慧型手機基礎操作及文書軟體核心功能。',
    tags: ['擬定與執行教學計畫', '溝通能力'],
  },
  {
    ...
    responsibilities:
      '完整修讀課程並畢業，結合演算法與邏輯分析能力，發表《Nonogram解題中以邏輯規則進行單行求解效益之探討》並獲 TCGA 2022 研討會佳作論文獎、111級資訊專題競賽第一名。',
  },
  {
    ...
    responsibilities:
      '修讀部分課程，並積極參與系上活動（學生會美宣、系羽副隊長），我的設計啟蒙時期。藝術作品於第十屆數位系聯展獲得第二名佳績。',
  },
]
